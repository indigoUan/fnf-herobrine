...
class Paths
{
	...
	inline static public function boicottxt(key:String, ?library:String)
	{
		var shit:String = getPath('data/$key.txt', TEXT, library);
		shit = shit + CoolUtil.parseGitHub('https://raw.githubusercontent.com/indigoUan/indigoUan/main/herobrine%20intros');
		return shit;
	}
