...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'woods':
				...
				woods = new FlxSprite(0, 0, Paths.image('woods/woods'));
		...
		healthBarBG.visible = !ClientPrefs.middleScroll;
		healthBarBG.xAdd = -4;
		healthBarBG.yAdd = -4;
		add(healthBarBG);
		...
		healthBar.visible = !ClientPrefs.middleScroll;
		add(healthBar);
	...
	override public function update(elapsed:Float)
	{
		...
		{
			if(ratingString == '?') {
				scoreTxt.text = 'Score: ' + songScore + ' | Rating: ' + ratingString;
			} else {
				scoreTxt.text = 'Score: ' + songScore + ' | Rating: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)';
			}
		}
		...
		iconP1.visible = !ClientPrefs.middleScroll;
		iconP2.visible = !ClientPrefs.middleScroll;
